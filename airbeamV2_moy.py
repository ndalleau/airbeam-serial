...
sampleTime= 10  #nbre d'échantillons de données
json_bodySum={
              "fields":{
                        "F":0,
                        "C":0,
...
if __name__ == '__main__':
    ...
    if args.device in os.listdir("/dev"):
        ...
        for i in os.listdir("/dev"):
            if 'tty' in i[:3]:
                print(i)#dataExemple=['Temperature', 'Counts', '8', 'Plantower', 'Counts', '1', 'Airbeam2', 'MAC', '0018961054F1', 'Firmware', 'v11.5.18', '78F', '26C', '299K', '56RH', 'PM1', '3', 'PM2.5', '7', 'PM10', '9']
